# -*- coding: utf-8 -*-
"""CSE110 Lab Assignment 1 (Branching).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1yDNWWhF3j9e4BrMtG253p1vGuFLNqhnv
...
#todo
first_number = input("Enter your first number here\n")
...
second_number = input("Enter your secont number\n")

if float(first_number) > float(second_number):
  print(float(first_number) - float(second_number)) #using float instead of int
elif float(first_number) < float(second_number):
   print(float(second_number) - float(first_number))
else:
  print(float(second_number) - float(first_number))
...
if number_integer % 2 == 0 or number_integer % 5 == 0:
...
if number_integer % 2 == 0 and number_integer % 5 != 0 or number_integer % 2 != 0 and number_integer % 5 == 0:
  print(number_integer)
elif number_integer % 2 == 0 and number_integer % 5 == 0:
...
if number_integer % 2 == 0 and number_integer % 5 == 0:
  print(number_integer)
else:
...
#todo
second = int(input("Enter the time value in SECOND\n"))

hour = second // 3600
extra_second = second % 3600 
minutes = extra_second // 60 
more_extra_second = extra_second % 60

print("Hours:",hour,"Minutes:",minutes,"Seconds:",more_extra_second)
#print("%d:%d:%d" % ( hour, minutes, more_extra_second))
...
#todo
worked_hour = int(input("How many hours did you work this week?\n"))
weekly_wages = 0
extra_hour = 0
extra_wages = 0
...
if worked_hour < 0 :
  ...
  extra_wages = extra_hour * 300                                  
  weekly_wages = 8000 + extra_wages
  print(weekly_wages)
elif worked_hour <= 40:
  weekly_wages = worked_hour * 200
  print(weekly_wages)
...
#todo
s_value = int(input("Enter the value of S\n"))

if s_value < 100:
 print(3000 - (125 * (s_value ** 2)))
elif s_value >= 100:
  print(12000 / (4 + ((s_value ** 2) / 14900)))
...
#todo
time = int(input("Enter the valur of time\n"))
...
#todo
number = int(input("Enter your exam markas\n"))
...
celsius_main = ((fahrenheit - 32) * 0.56)
celsius = round(celsius_main,3)
...
#todo
distance_meters = float(input("Enter the distance value in METERS\n"))
time_seconds = float(input("Enter the time in SECONDS\n"))

distance_kilometers = distance_meters / 1000
time_hours = time_seconds / 3600

valocity = round(distance_kilometers / time_hours, 2)

if valocity < 60:
  print(f"{valocity} Km/h")
  print("Too slow. Needs more changes.")
elif valocity >= 60 and valocity <= 90:
  print(f"{valocity} km/h")
...
credit = int(input("How many credit did you take?\n"))

if credit >= 30 and cgpa == 4:
  print("The student is eligible for a waiver of 100 percent.")
elif credit >= 30 and cgpa >= 3.95 and cgpa <=3.99:
  print("The student is eligible for a waiver of 75 percent.")
elif credit >= 30 and cgpa >= 3.90 and cgpa <=3.94:
  print("The student is eligible for a waiver of 50 percent.")
elif credit >= 30 and cgpa >= 3.80 and cgpa <=3.89:
  print("The student is eligible for a waiver of 25 percent.") 
elif credit < 30 or cgpa < 3.80:
...
#todo
canvas = int(input("The number of canvas\n"))
paint_tube = int(input("The number of paint tube\n"))

total_bill = canvas * 120 + paint_tube * 75

if 0 <= total_bill <= 299 :
  print(f"Previous total : {total_bill}")
  print(f"New total after discount : {total_bill}")
elif 300 <= total_bill <= 499:
   print(f"Previous total : {total_bill}")
   print(f"New total after discount : {total_bill - 10}")
elif 500 <= total_bill <= 749 :
   print(f"Previous total : {total_bill}")
   print(f"New total after discount : {total_bill -20}")
elif 750 <= total_bill <= 999 :
   print(f"Previous total : {total_bill}")
   print(f"New total after discount : {total_bill -50}")
elif total_bill >= 1000 :
   print(f"Previous total : {total_bill}")
   print(f"New total after discount : {total_bill -150}")